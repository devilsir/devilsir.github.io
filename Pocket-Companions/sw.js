...
const LOCAL_ASSETS = [
  ...
  './assets/models/animated_butterfly.glb',
  './assets/models/ulysses_butterfly.glb',
  './assets/models/rabbit_rigged.glb',
  './assets/models/accessories/bandanas/bandanas_01.glb',
  './assets/models/accessories/bandanas/bandanas_02.glb',
  './assets/models/accessories/bandanas/bandanas_03.glb',
  './assets/models/accessories/capas/capas_01.glb',
  './assets/models/accessories/capas/capas_02.glb',
  './assets/models/accessories/capas/capas_03.glb',
  './assets/models/accessories/chapeus/chapeus_01.glb',
  './assets/models/accessories/chapeus/chapeus_02.glb',
  './assets/models/accessories/chapeus/chapeus_03.glb',
  './assets/models/accessories/lacos/lacos_01.glb',
  './assets/models/accessories/lacos/lacos_02.glb',
  './assets/models/accessories/lacos/lacos_03.glb',
  './assets/models/accessories/mochilas/mochilas_01.glb',
  './assets/models/accessories/mochilas/mochilas_02.glb',
  './assets/models/accessories/mochilas/mochilas_03.glb',
  './assets/models/accessories/oculos/oculos_01.glb',
  './assets/models/accessories/oculos/oculos_02.glb',
  './assets/models/accessories/oculos/oculos_03.glb',
  './css/base.css',
  './css/components.css',
  './css/responsive.css',
  './js/animations.js',
  ...
  './js/scene/effects.js',
  './js/scene/interactions.js',
  './js/scene/accessories.js',
  './js/scene/media.js',
  './js/scene/activities.js',
  './js/scene/building.js',
  './js/simulation/agent.js',
  './js/simulation/body-language.js',
  './js/simulation/environment-actions.js',
  './js/simulation/events.js',
  './js/simulation/habits.js',
  './js/simulation/memory.js',
  './js/simulation/offline-simulation.js',
  './js/simulation/routines.js',
  './js/simulation/schema.js',
  './js/simulation/simulation.js',
  './js/simulation/species-behaviors.js',
  './js/simulation/training.js',
  './js/simulation/utility-ai.js',
  './js/store.js',
  './js/utils.js',
