...
const ROOM_OBJECTS = {
  living: [
    { id: 'living-bed', type: 'bed', approach: [-1.55, -0.25], interaction: [-3.35, -1.7], surfaceY: 0.52, actions: ['sleep', 'bed-rest', 'hide'], exclusive: true },
    ...
    { id: 'living-shelf-perch', type: 'perch', approach: [-3.2, 0.65], interaction: [-4.35, 0.6], surfaceY: 0.92, actions: ['climb', 'high-rest'], species: ['cat'], exclusive: true }
  ],
  bedroom: [
    { id: 'bedroom-bed', type: 'bed', approach: [-0.25, 0.65], interaction: [-2.8, -1.4], surfaceY: 0.7, actions: ['sleep', 'bed-rest', 'sleep-near-pet'], exclusive: true },
    ...
    { id: 'bedroom-shelf-perch', type: 'perch', approach: [3.15, 0.35], interaction: [4.35, 0.2], surfaceY: 0.92, actions: ['climb', 'high-rest'], species: ['cat'], exclusive: true },
  ...
  kitchen: [
    ...
    { id: 'kitchen-table-perch', type: 'perch', approach: [2.9, 1.7], interaction: [0.8, 0.5], surfaceY: 1.05, actions: ['climb', 'high-rest'], species: ['cat'], exclusive: true }
  ],
  garden: [
    ...
    { id: 'garden-tree-perch', type: 'perch', approach: [-2.7, -1.1], interaction: [-3.35, -1.5], surfaceY: 0.72, actions: ['climb', 'high-rest'], species: ['cat'], exclusive: true }
  ],
  playroom: [
  ...
  training: [
    { id: 'training-hurdles', type: 'obstacle', approach: [-4.0, -2.15], actions: ['trained-command', 'explore'], exclusive: true },
    { id: 'training-platform', type: 'marker', approach: [2.0, 2.1], interaction: [3.4, 2.1], surfaceY: 0.46, actions: ['trained-command', 'high-rest'], exclusive: true },
